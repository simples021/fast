...
```bash
sudo bash -c "$(curl -sL https://simples021/scripts-1/raw/master/marzban.sh)" @ install
```

Run the following command to install Marzban with MySQL database:

```bash
sudo bash -c "$(curl -sL https://simples021/scripts-1/raw/master/marzban.sh)" @ install --database mysql
```

Run the following command to install Marzban with MariaDB database:
```bash
sudo bash -c "$(curl -sL https://simples021/scripts-1/raw/master/marzban.sh)" @ install --database mariadb
```
...
```bash
sudo bash -c "$(curl -sL https://simples021/scripts-1/raw/master/marzban.sh)" @ install-script
```
